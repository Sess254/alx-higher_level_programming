...
class TestRectangle_height(unittest.TestCase):
    """Unittests for initialization of Rectangle height attribute."""
...
class TestRectangle_x(unittest.TestCase):
    """Unittests for initialization of Rectangle x attribute."""
...
class TestRectangle_y(unittest.TestCase):
    """Unittests for initialization of Rectangle y attribute."""
...
class TestRectangle_order_of_initialization(unittest.TestCase):
    """Unittests for Rectangle order of attribute initialization."""
